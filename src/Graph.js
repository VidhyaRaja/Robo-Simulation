...
const Graph = props => {
    ...
    useEffect(() => {
        ...
        let grid_size = 60;
        let x_axis_distance_grid_lines = 8;
        let y_axis_distance_grid_lines = 2;
    ...
    return <canvas className= "container d-flex justify-content-center" ref={canvasRef} width="800" height="800"/>;
}
